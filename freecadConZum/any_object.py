...
def update():
	...
	#-- canceled code>> Change the torus rotation
	#-- canceled code>> rot = App.Rotation(App.Vector(1,0,1),angle)
	#-- canceled code>> Torus.Placement.Rotation = rot
	# Line added. This line 
	App.getDocument("MoviendoObjetos").Fillet.Placement=App.Placement(App.Vector(0,0,0), App.Rotation(App.Vector(0,0,1),angle), App.Vector(0,0,0))
...
# canceled code   doc = App.newDocument("Example")

#-- Add a Torus
#canceled code   Torus = doc.addObject("Part::Torus","Torus")
#canceled code   doc.recompute()
